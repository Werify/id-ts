export declare const werify: () => {
    ...
    getUserProfile: (accessToken: string, endpoint: string) => Promise<import("./modules/private/getUserProfile/interface/IUserProfile").IGetUserResponse>;
    getUserNumbers: (accessToken: string, endpoint: string) => Promise<any>;
    getFinancialInfo: (accessToken: string, endpoint: string) => Promise<import("./modules/private/getFinancialInfo/interface/IFinancialInfo").IGetFinancialInfoResponse>;
